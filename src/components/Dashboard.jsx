              ...
              <div key={task.id}
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1 min-w-0">
                    {/* Fila 1: nombre + badges OS y serviceType */}
